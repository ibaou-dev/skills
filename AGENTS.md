...
# Edit .bench/<skill-name>/bench.json to configure executors/judges
...
# Merged results table (latest per label)
...
# Then run with auto-dep install
...
**OpenCode discovery symlink (manual, if needed):**
